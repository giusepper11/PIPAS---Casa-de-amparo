...
from casa_amparo.home.views import SignupProfileView
import allauth.account.views as allauth_account_view

from casa_amparo.users.views.pessoa_fisica import pessoa_fisica_signup
from casa_amparo.users.views.pessoa_juridica import pessoa_juridica_signup
