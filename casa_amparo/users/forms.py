...
from localflavor.br.forms import BRCPFField, BRZipCodeField,BRCNPJField
from casa_amparo.users.models import Cidade, Estado
from casa_amparo.users.models import PessoaJuridica, PessoaFisica, CustomUser
