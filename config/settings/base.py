...
ROOT_DIR = environ.Path(__file__) - 3  # (casa_amparo/config/settings/base.py - 3 = casa_amparo/)
APPS_DIR = ROOT_DIR.path('casa_amparo')
env = environ.Env()
...
MIGRATION_MODULES = {
    'sites': 'casa_amparo.contrib.sites.migrations'
}
...
ADMINS = [
    ("""PIPAS devteam""", 'pipas-devteam@example.com'),
]
